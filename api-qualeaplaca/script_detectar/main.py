...
def clean_images():
	file_list = os.listdir('./outputs/images')
	for file_name in file_list:
		if '.png' in file_name:
			os.remove('./outputs/images/' + file_name)
...
def main(args):
    ...
    out = cv2.VideoWriter('./outputs/output.avi',fourcc, fps , (640,480))
